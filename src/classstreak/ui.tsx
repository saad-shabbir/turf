...
import { Animated, ScrollView, Text, TextInput, View, StyleSheet, type ViewStyle, type TextStyle } from "react-native";
...
export const themes = {
  ...
  sage: { paper: "#F4F8F5", card: "#FFFFFF", ink: "#1E2E27", accent: "#22795A", tint: "#D5EBDD", muted: "#5F7369", line: "#DCE8E0" },
...
export function Screen({ children, footer, scroll = true, style }: { children: React.ReactNode; footer?: React.ReactNode; scroll?: boolean; style?: ViewStyle }) {
  ...
  return <Entrance><View style={{ flex: 1, backgroundColor: t.paper }}>{scroll ? <ScrollView automaticallyAdjustKeyboardInsets keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>{inner}</ScrollView> : inner}{footer && <View style={{ paddingHorizontal: 20, paddingBottom: 18, paddingTop: 8, gap: 9, backgroundColor: t.paper }}>{footer}</View>}</View></Entrance>;
}
